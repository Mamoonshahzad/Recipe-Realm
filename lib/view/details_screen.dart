            ...
            child: SingleChildScrollView(
                child: Column(
                  ...
                  Container(
                      ...
                      child: ClipRRect(
                          borderRadius:
                              BorderRadius.circular(20), // Clip the image
                          child: Image.asset(selectedItem.imageUrl as String,
                              fit: BoxFit.cover))),
                  const SizedBox(height: 16),
                  const Divider(height: 1),
                  Align(
                      alignment: Alignment.center,
                      child: Text(selectedItem.itemName as String,
                  ...
                  Container(
                      ...
                      child: Column(children: [
                        ...
                        Text(selectedItem.ingredients.toString(),
                            style:
                                GoogleFonts.notoSerifMalayalam(fontSize: 15)),
                        Text("\nInstructions:",
                            style: GoogleFonts.notoSerifMalayalam(
                                fontWeight: FontWeight.bold, fontSize: 17)),
